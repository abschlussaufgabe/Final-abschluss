...
public class Game {
    ...
    public boolean playTurnStandard(int row1,int col1,int row2, int col2 , Player player) throws IllegalArgumentException{
    ...
    public boolean winTorusLeftDiagonal(Player player) {
    	boolean won = false;
    	int n = board.length;
    	if((board[0][0] + board[n-1][n-1] + board[n-2][n-2] + 
    	    board[n-3][n-3] + board[n-4][n-4] + board[n-5][n-5])
    	    .equals(player.getName() + player.getName() + player.getName() +
    	            player.getName() + player.getName() + player.getName()) ) {
    		won = true;
    	}
    	...
    	else if((board[0][0] + board[1][1] + board[n-1][n-1] +
    			 board[n-2][n-2] + board[n-3][n-3] + board[n-4][n-4])
                 .equals(player.getName() + player.getName() + player.getName() +
                         player.getName() + player.getName() + player.getName())){
                        	 won = true;
                         }
    	...
    	else if((board[0][0] + board[1][1] + board[2][2] + board[n-1][n-1] + board[n-2][n-2] + board[n-3][n-3])
    			 .equals(player.getName() + player.getName() + player.getName() + 
    					 player.getName() + player.getName() + player.getName())) {
    		won = true;
    	}
